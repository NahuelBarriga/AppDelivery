...
class PedidoRepository {
    ...
    private val pedidosDePrueba = listOf(
        Pedido(id = 1, nombreCliente = "Nahuel", estado = "PENDIENTE", listaItems = emptyList(), total = 500.0),
        Pedido(id = 2, nombreCliente = "Lucía", estado = "EN PREPARACIÓN", listaItems = emptyList(), total = 500.0),
        Pedido(id = 3, nombreCliente = "Juan", estado = "ENTREGADO", listaItems = emptyList(), total = 500.0)
    )
